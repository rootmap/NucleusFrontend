...
if (isset($_POST['create'])) {
    ...
    if (!empty($price_cost) && !empty($price_retail) && !empty($quantity)) {
        if ($pid == 0) {
            if ($obj->insert($table, array("name" => $name, "description" => $description, "barcode" => $barcode,
    ...
    if (!empty($price_cost) && !empty($price_retail)) {
        if ($input_status == 1) {
            if ($obj->update($table, array("id" => $id,
                ...
                $obj->Success("Successfully Saved", $obj->filename() . "?edit=" . $id);
            } else {
                $obj->Error("Something is wrong, Try again.", $obj->filename() . "?edit=" . $id);
            }
        } else {
            $owner_id = $obj->SelectAllByVal($table, "id", $id, "store_id");
        ...
        <div class="wrapper three-columns">
                    ...
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <?php if (isset($_GET['edit'])) { ?>
                                <h5><i class="icon-edit"></i> Edit Phone Inventory Product </h5>
                            <?php } else { ?>
                                <h5><i class="font-plus-sign"></i> Add Phone Inventory Product </h5>
                            <?php } ?>
                            <ul class="icons">
                                            ...
                                            <div class="row-fluid  span12 well">     
                                                ...
                                                <div class="span6" style="padding:0px; margin:0px;">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls"><input value="<?php echo $obj->SelectAllByVal("product", "id", $_GET['edit'], "name"); ?>" class="span12 k-textbox" type="text" name="name" /></div>
                                                    </div>

                                                    <div class="control-group">
                                                        <label class="control-label"> Description</label>
                                                        <div class="controls"><input  value="<?php echo $obj->SelectAllByVal("product", "id", $_GET['edit'], "description"); ?>"  class="span12 k-textbox" type="text" name="description" /></div>
                                                    </div>

                                                    <div class="control-group">
                                                        <label class="control-label"> UPC/Barcode </label>
                                                        <div class="controls"><input readonly  value="<?php echo $obj->SelectAllByVal("product", "id", $_GET['edit'], "barcode"); ?>"  class="span12 k-textbox" type="text" name="barcode" /></div>
                                                    </div>

                                                    <div class="control-group">
                                                        <label class="control-label">* Price cost</label>
                                                        <div class="controls"><input  value="<?php echo $obj->SelectAllByVal("product", "id", $_GET['edit'], "price_cost"); ?>"  class="span12 k-textbox" type="text" name="price_cost" /></div>
                                                    </div>

                                                    <div class="control-group">
                                                        <label class="control-label">* Price retail</label>
                                                        <div class="controls"><input  value="<?php echo $obj->SelectAllByVal("product", "id", $_GET['edit'], "price_retail"); ?>"  class="span12 k-textbox" type="text" name="price_retail" /></div>
                                                    </div>

                                                    <div class="control-group">
                                                        <label class="control-label">Discount</label>
                                                        <div class="controls">
                                                            <input type="text"  value="<?php echo $obj->SelectAllByVal("product", "id", $_GET['edit'], "discount"); ?>"   name="discount" class="maskPct span4 k-textbox"  /></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <label class="checkbox"><div id="uniform-undefined" class="checker">
                                                                    <span class="checked"><input style="opacity: 0;" value="1" name="taxable" class="style k-textbox" <?php
                                                            ...
                                                            <label class="checkbox"><div id="uniform-undefined" class="checker">
                                                                    <span class="checked"><input    style="opacity: 0;" value="1" name="maintain_stock" class="style k-textbox" <?php
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls"><input  value="<?php echo $obj->SelectAllByVal("product", "id", $_GET['edit'], "notes"); ?>"  class="span12 k-textbox" type="text" name="notes" /></div>
                                                    </div>
                                                ...
                                                <div class="span6" style="padding:0px; margin:0px; float:right;">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input class="span6 k-textbox"  value="<?php echo $obj->SelectAllByVal("product", "id", $_GET['edit'], "quantity"); ?>"  type="number" name="instock" />
                                                        </div>
                                                    </div>

                                                    <div class="control-group">
                                                        <label class="control-label">Reorder at:</label>
                                                        <div class="controls"><input  value="<?php echo $obj->SelectAllByVal("product", "id", $_GET['edit'], "reorder"); ?>"  class="span4 k-textbox" type="number" name="reorder" /></div>
                                                    </div>

                                                    <div class="control-group">
                                                        <label class="control-label">Condition:</label>
                                                        <div class="controls"><input  value="<?php echo $obj->SelectAllByVal("product", "id", $_GET['edit'], "conditions"); ?>"  class="span12 k-textbox" type="text" name="condition" /></div>
                                                    </div>

                                                    <div class="control-group">
                                                        <label class="control-label">Physical location:</label>
                                                        <div class="controls"><input  value="<?php echo $obj->SelectAllByVal("product", "id", $_GET['edit'], "physical_location"); ?>"  class="span12 k-textbox" type="text" name="physical_location" /></div>
                                                    </div>
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls"><input  value="<?php echo $obj->SelectAllByVal("product", "id", $_GET['edit'], "sort_order"); ?>"  class="span2 k-textbox" type="number" name="sort_order" /></div>
                                                    </div>
                                                    <?php if ($input_status == 1 || $input_status == 2) { ?>
                                                        <div class="control-group">
                                                            <label class="control-label">&nbsp;</label>
                                                            <div class="controls"><button type="submit" name="update" class="k-button"><i class="icon-check"></i> Update Item Info </button></div>
                                        ...
                                        <?php } else { ?>
                                            <div class="row-fluid  span12 well">     
                                                ...
                                                <div class="span6" style="padding:0px; margin:0px;">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls" id="ppid">
                                                            <input class="k-textbox" name="pid" onChange="product(this.value)" style="width: 250px;"> 
                                                        </div>
                                                    </div>

                                                    <div class="control-group">
                                                        <label class="control-label"> Description</label>
                                                        <div class="controls"><input  placeholder="Please Type Product Description" class="span12 k-textbox" type="text" name="description" id="description" /></div>
                                                    </div>

                                                    <div class="control-group">
                                                        <label class="control-label"> Barcode </label>
                                                        <div class="controls"><input placeholder="Please Type Product UPC / Barcode" class="span12 k-textbox" type="text" name="barcode" id="barcode" /></div>
                                                    </div>

                                                    <div class="control-group">
                                                        <label class="control-label">* Price cost</label>
                                                        <div class="controls"><input placeholder="Please Type Price Cost" class="span12 k-textbox" type="text" name="price_cost" id="price_cost" /></div>
                                                    </div>

                                                    <div class="control-group">
                                                        <label class="control-label">* Price retail</label>
                                                        <div class="controls"><input placeholder="Please Type Price Retail" class="span12 k-textbox" type="text" name="price_retail" id="price_retail" /></div>
                                                    </div>

                                                    <div class="control-group">
                                                        <label class="control-label">Discount</label>
                                                        <div class="controls">
                                                            <input type="text" placeholder="Product Discount" name="discount" id="discount" class="maskPct span4 k-textbox" /></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <label class="checkbox"><div id="uniform-undefined" class="checker">
                                                                    <span class="checked"><input style="opacity: 0;" value="1" name="taxable" class="style k-textbox" checked="" type="checkbox"></span>
                                                                </div> Taxable
                                                            </label>

                                                            <label class="checkbox"><div id="uniform-undefined" class="checker">
                                                                    <span class="checked"><input style="opacity: 0;" value="1" name="maintain_stock" class="style k-textbox" checked="" type="checkbox"></span>
                                                                </div> Maintain Stock
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="control-group">
                                                        <label class="control-label"> Notes</label>
                                                        <div class="controls"><input placeholder="Please Type Product Notes" class="span12 k-textbox" type="text" name="notes" /></div>
                                                    </div>
                                                ...
                                                <div class="span6" style="padding:0px; margin:0px; float:right;">
                                                    ...
                                                    <input class="span6 k-textbox"  placeholder="Instock Quantity"  readonly type="hidden" id="instock" name="instock" />
                                                    <div class="control-group">
                                                        <label class="control-label">Reorder at:</label>
                                                        <div class="controls"><input  placeholder="Product Re-Order"  class="span8 k-textbox" type="number" name="reorder" id="reorder" /></div>
                                                    </div>

                                                    <div class="control-group">
                                                        <label class="control-label">* Quantity:</label>
                                                        <div class="controls"><input placeholder="Product Current Quantity"  class="span8 k-textbox" type="number" name="quantity" id="quantity" /></div>
                                                    </div>

                                                    <div class="control-group">
                                                        <label class="control-label">Condition:</label>
                                                        <div class="controls"><input  placeholder="Product Condition"  class="span12 k-textbox" type="text" name="condition" /></div>
                                                    </div>

                                                    <div class="control-group">
                                                        <label class="control-label">Physical location:</label>
                                                        <div class="controls"><input  placeholder="Product Physical Location"  class="span12 k-textbox" type="text" name="physical_location" /></div>
                                                    </div>

                                                    <div class="control-group">
                                                        <label class="control-label">Warranty Length:</label>
                                                        <div class="controls">
                                                            <select name="warranty" style="width: 200px;">
                                                                <?php for ($i = 1; $i <= 600; $i++): ?>
                                                    ...
                                                    <div class="control-group">
                                                        <label class="control-label">Sort order:</label>
                                                        <div class="controls"><input class="span4 k-textbox" type="number" name="sort_order" /></div>
                                                    </div>
            ...
            <script>
                nucleus("input[name='pid']").kendoComboBox({
                    ...
                    placeholder: "Select Phone Inventory Product.",
                    dataTextField: "name",
                    dataValueField: "id",
                    filter: "contains",
                    dataSource: {
                        ...
                        transport: {
                            read: "./controller/dropdown.php?inventory_phone=1"
                        }
                    }
