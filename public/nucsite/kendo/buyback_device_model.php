                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="font-cogs"></i> BuyBack Device Model Setting </h5>
                            <ul class="icons">
                                        ...
                                        <div class="row-fluid  span6 well">     
                                            <!-- Selects, dropdowns -->
                                                ...
                                                <div class="control-group">
                                                    <label class="span12"> Device Model </label>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row-fluid  span6 well">     
                                            <!-- Selects, dropdowns -->
                                                ...
                                                <div class="control-group">
                                                    <label class="span12"> Device Model </label>
                                                        <input class="span6 k-textbox" placeholder="Put Here Device Model Name" type="text" name="name" />
                                                </div>
...
<div class="control-group">
                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
                                    <h5><i class="icon-list-alt"></i>Buyback Device Model List</h5>
                                        <ul class="icons">
                            ...
                            <div class="table-overflow">
                                ...
                                <div id="grid" style="margin-left: 10px;margin-right: 10px;"></div>
                                            ...
                                            <script id="action_template" type="text/x-kendo-template">
                                                <a class="k-button k-button-icontext k-grid-delete" href="buyback_device_model.php?edit=#=id#"><i class="icon-edit"></i> Edit</a> 
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                type: "POST",
                                                        dataType: "json",
                                                        url: "./controller/buyback_device_model.php",
                                                        data: {id: id},
