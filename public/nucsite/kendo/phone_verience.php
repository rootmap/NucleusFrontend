                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="icon-random"></i> Phone Variance Report <?php if (isset($_GET['lotno'])) { ?> Detail | <a href="<?php echo $obj->filename(); ?>">Back To Phone Variance Report List</a> <?php } ?></h5>
                            <ul class="icons">
                                                ...
                                                function deleteClick(id) {
                                                    ...
                                                    if (c === true) {
                                                        $.ajax({
                                                            type: "POST",
                                                            dataType: "json",
                                                            url: "./controller/veriance_phone.php",
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                jQuery(document).ready(function () {
                                                    ...
                                                    var dataSource = new kendo.data.DataSource({
                                                        ...
                                                        transport: {
                                                            read: {
                                                                url: "./controller/veriance_phone.php<?php echo $cond; ?>",
                                                                type: "GET",
                                                                datatype: "json"
                                                            }
                                                        },
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                jQuery(document).ready(function () {
                                                    ...
                                                    var dataSource = new kendo.data.DataSource({
                                                        ...
                                                        transport: {
                                                            read: {
                                                                url: "./controller/veriance_phone.php<?php echo $newcond; ?>",
                                                                type: "GET",
                                                                datatype: "json"
                                                            }
                                                        },
                                ...
                                <div class="table-overflow">
                                    ...
                                    if (!isset($_GET['lotno'])) {
                                        ...
                                        <table class="table table-striped" id="data-table">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql_product=$obj->FlyQuery("SELECT a.*,s.name as input_bys FROM varience as a LEFT JOIN store as s on s.id=a.input_by WHERE a.store_id='" . $input_by . "' AND a.status='2' ORDER BY a.id DESC");
                                                $i=1;
                                            ...
                                            <table class="table table-striped" id="data-table">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $lotno=$_GET['lotno'];
                                                    $sql_product=$obj->SelectAllByID_Multiple("product_verience", array("store_id"=>$input_by, "lotno"=>$lotno, "status"=>2));
                                                    $i=1;
                                                    if (!empty($sql_product))
                                                        foreach ($sql_product as $product):
                                                            ?>
