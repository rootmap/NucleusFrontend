...
/*INSERT INTO order_list (`order_id`, `event_id`, `event_name`, `order_read`, `order_updated_by`, `order_billing_phone`, `address`, `order_user_id`, `name`, `order_updated_on`, `order_number`, `order_created`, `order_status`, `order_payment_type`, `order_quantity`, `total`, `admin_full_name`) 
		SELECT 
        orders.order_id,
        e.event_id,
        e.event_title,
        ...
        LEFT JOIN (SELECT event_id,event_title FROM events) as e ON `oe`.OE_event_id = e.event_id 
        ...
        orders.order_id DESC LIMIT 0,5