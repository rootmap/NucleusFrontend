                            ...
                            <div class="container">
                                <!-- Content Start from here customized -->
                                    ...
                                    <script id="action_template" type="text/x-kendo-template">
                                        <a class="k-button k-button-icontext k-grid-delete" href="store_cashier_list.php?edit=#=id#"><i class="icon-edit"></i> Edit</a> 
                                        ...
                                        function deleteClick(id) {
                                            ...
                                            if (c === true) {
                                                $.ajax({
                                                    type: "POST",
                                                    dataType: "json",
                                                    url: "./controller/store_cashier_list.php",
                                                    data: {id: id},
                                            ...
                                            jQuery("#grid").kendoGrid({
                                                ...
                                                columns: [
                                                    ...
                                                    <?php /*<table class="table table-striped" id="data-table">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $sql_store=$obj->SelectAll("store_cashier");
															$i=1;
