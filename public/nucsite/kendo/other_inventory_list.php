...
if (isset($_POST['create'])) {
    ...
    if ($s == 0) {
        ...
        //$obj->Success("Verience Successfully Created / Updated.", "other_inventory_verience.php?lotno=" . $lotno);
                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="font-home"></i> Create Other Inventory Variance</h5>
                            <ul class="icons">
                                                    ...
                                                    if (!empty($sql_product))
                                                        foreach ($sql_product as $product):
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="create_other_inventory_verience.php?pid=<?php echo $product->id; ?>" class="label label-info hovertip" title="Create a Variance">
