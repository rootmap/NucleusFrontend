                            ...
                            <div class="container">
                                ...
                                <div class="table-overflow">
                                    ...
                                    <script id="action_template" type="text/x-kendo-template">
                                        <a class="k-button k-button-icontext k-grid-delete" href="super_admin_list.php?edit=#=id#"><i class="icon-edit"></i> Edit</a> 
                                        ...
                                        function deleteClick(id) {
                                            ...
                                            if (c === true) {
                                                $.ajax({
                                                    type: "POST",
                                                    dataType: "json",
                                                    url: "./controller/super_admin_list.php",
                                                    data: {id: id},
                                        ...
                                        jQuery(document).ready(function () {
                                            ...
                                            jQuery("#grid").kendoGrid({
                                                ...
                                                columns: [
                                                    ...
                                                    {field: "status", title: "User Type", width: "70px"},
                                                    {
                                    ...
                                    <?php /* <table class="table table-striped" id="data-table">
                                      ...
                                      <tbody>
                                      <?php
                                      $sql_store=$obj->SelectAll("super_admin");
                                      $i=1;
