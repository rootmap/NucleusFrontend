...
extract($_GET);
$sqlpagecheckinrequest=$ops->FlyQuery("select checkin_id,first_name,last_name,email,phone,access_id,(SELECT name FROM store WHERE store.store_id=checkin_request.input_by AND store.`status`=2) as input_by,date,
