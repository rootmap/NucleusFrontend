                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="icon-random"></i> <?php if (!isset($_GET['ac'])) { ?> Create Checkin Variance <?php }else { ?> Variance Report <?php } ?> </h5>
                            <ul class="icons">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="well row-fluid block">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls"><input class="span8 k-textbox" type="text" name="white" /></div>
                                                </div>
                                                <div class="control-group">
                                                    <label class="control-label">Black</label>
                                                    <div class="controls"><input class="span8 k-textbox" type="text" name="black" /></div>
                                                </div>
                                                <div class="control-group">
                                                    <label class="control-label">Warranty</label>
                                                    <div class="controls"><input class="span8 k-textbox" type="text" name="warranty" /></div>
                                                </div>
                                                <div class="control-group">
                                                    <label class="control-label">Your Quantity</label>
                                                    <div class="controls"><input class="span8 k-textbox" type="text" name="quantity" /></div>
                                                </div>
