...
if(isset($_POST['create']))
{
	...
	if($chk==0)
	{
		if($obj->insert($table,array("store_id"=>$input_by,"enable_pos"=>$enable_pos, "date"=>date('Y-m-d'), "status"=>1))==1)
		{
	...
	{
		if($obj->update($table,array("store_id"=>$input_by,"enable_pos"=>$enable_pos, "date"=>date('Y-m-d'), "status"=>1))==1)
		{
                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="font-cogs"></i> POS Setting </h5>
                            <ul class="icons">
                                        ...
                                        <!-- General form elements -->    
                                            <!-- Selects, dropdowns -->
                                                ...
                                                <label class="checkbox"><div id="uniform-undefined" class="checker">
                                                            <span class="checked"><input style="opacity: 0;" name="enable_pos" value="1" class="style" <?php $enable_pos=$obj->SelectAllByVal($table,"store_id",$input_by,"enable_pos"); if($enable_pos!=0){ echo "checked"; } ?> type="checkbox"></span>
                                                        </div> Enable POS Module
                                                    </label>
                                                    <div class="gap"></div>
