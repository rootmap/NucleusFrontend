...
$obj->Success("Welcome To HelpDesk Videos.","helpdesk_include.php");
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="icon-eye-open"></i> Help Desk </h5>
                            <ul class="icons">
                                           ...
                                           <!-- Selects, dropdowns -->
                                            ...
                                            <!-- /selects, dropdowns -->
                                                ...
                                                <script>
                                                    $('#youmax').youmax({
                                                        apiKey:'AIzaSyDEm5wGLsWi2G3WG40re-DAJcWioQSpJ6o',
                                                        youTubeChannelURL:"https://www.youtube.com/channel/UC-fp06uZ6scPR-h6FzDwWEg",
                                                        
                                                        youTubePlaylistURL:"https://www.youtube.com/channel/UC-fp06uZ6scPR-h6FzDwWEg/videos",
                                                        youmaxDefaultTab:"Uploads",
                                                        youmaxColumns:3,
