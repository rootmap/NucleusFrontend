...
<html lang="en">
    <head>
        ...
        echo $cms->GeneralCss(array("kendo", "color"));
        ?>
        ...
        <div class="wrapper three-columns">
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="span11 well">     
                                                            ...
                                                            if (!empty($_GET['price'] && !empty($_GET['price2']))) {
                                                                ...
                                                                if (empty($_GET['price'] && !empty($_GET['price2']))) {
                                                                    @$pr_price_two = $_GET['price2'];
                                                                    $obj->delete("check_user_price", array("ckeckin_id" => $cart));
                                                                    $obj->insert("check_user_price", array("ckeckin_id" => $cart, "store_id" => $input_by, "access_id" => $input_by, "price" => $pr_price_two, "date" => date('Y-m-d'), "status" => 1));
                                                                } else {
                                                                    @$pr_price_two = $_GET['price2'];
                                                                    $obj->delete("check_user_price", array("ckeckin_id" => $cart));
                                                                    $obj->insert("check_user_price", array("ckeckin_id" => $cart, "store_id" => $input_by, "access_id" => $input_by, "price" => $pr_price_two, "date" => date('Y-m-d'), "status" => 1));
                                                            ...
                                                            if ($chkexpro == 0) {
                                                                ...
                                                                $chkexpros = $obj->exists_multiple("product", array("name" => $make_new_pr_names, "input_by" => $input_by));
                                                                if ($chkexpros == 0) {
                                                            ...
                                                            <span id="newcus">
                                                                <div class="control-group">
                                                                    ...
                                                                    <div id="newcus">
                                                                        <select style="width: 200px;" name="customername" onChange="new_customer_checkin(this.value)" id="customername">
            ...
            <script>
                nucleus("#customername").kendoDropDownList({
                    optionLabel: " -- Please Select A Customer -- "
