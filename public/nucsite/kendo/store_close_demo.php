                   ...
                   <div class="modal-body">
                	...
                	<div class="row-fluid" id='storeprint'>
                        ...
                        <span> <strong>Store Closing Detail | <?php echo date('m/d/Y'); ?></strong> </span>
                            ...
                            $sqlamountsales=$report->SelectAllDateCondTime("invoice_payment","input_by",$input_by,"payment_type","3",$opcdatetime,date('Y-m-d H:i'),1);
                            $amounts=0;
                            $cashtax=0;
							$counttransactrion=count($sqlamountsales);
                            ...
                            $sqlamountsalesp=$report->SelectAllDateCondTime("invoice_payment","input_by",$input_by,"payment_type","4",$opcdatetime,date('Y-m-d H:i'),1);
                            $amountsp=0;
                            $cratax=0;
