                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="icon-file"></i> Estimate ID : - <?php echo $cart; ?> <a target="_blank" href="estimate_list.php?action=pdf&invoice=<?php echo $cart; ?>" class="hovertip" title="Print" onclick="javascript:return confirm('Are you absolutely sure to Print This Estimate ?')"><i class="icon-print"></i></a>
                                                                    </span></h5>
                            <ul class="icons">
									 ...
									 ?>
                                        ...
                                        <div class="row-fluid block">
                                            ...
                                            <div class="well row-fluid span6">
                                                ...
                                                <div class="clearfix"></div>
                                                <div class="span12">
                                                    <label class="span12"> <strong class="span4">Estimate Email: </strong><span class="span8">
                                            ...
                                            <div class="well row-fluid span6" <?php if($paid!=0){ ?>style="background:url(images/paid.png) no-repeat center;"<?php } ?>>
                                                <div class="navbar">
                                                    <div class="navbar-inner">
                                                        <h5><i class="font-money"></i> Estimate Detail</h5>
                                                    </div>
                                                </div>

                                                <br>
                                                <div class="span12">
                                                    <label class="span12"> <strong class="span3">Estimate Number: </strong> 
													<?php echo $cart; ?> </label>
                                                </div>
                                                ...
                                                <div class="clearfix"></div>
                                                <div class="span12">
                                                    <label class="span12"> <strong class="span3">Estimate Date: </strong>
