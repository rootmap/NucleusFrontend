        ...
        <div class="wrapper three-columns">
                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="font-lock"></i> Unlock Info</h5>
                            <ul class="icons">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls" id="newcus">
                                                <select style="width: 250px;" name="customername" onChange="new_customer_unlock(this.value)" id="customername">
                                                    <?php
                                                        if ($input_status == 1) {
            ...
            <script>
                nucleus("#customername").kendoDropDownList({
                    optionLabel: " -- Select A Customer For Unlock -- "
