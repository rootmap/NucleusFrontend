...
if(isset($_POST['save']))
{
	if($obj->exists_multiple($table,array("name"=>$name))==0)
	{
		...
		if($obj->insert($table,array("name"=>$_POST['name'],"status"=>1,"date"=>date('Y-m-d')))==1)
		{
			$obj->Success("Country Succesfully Saved",$obj->filename());	
		}
		else
		{
			$obj->Error("Country Saved Failed",$obj->filename());	
		}
	}
	else
	{
		$obj->Error("Country Already Exists",$obj->filename());	
	}
}
?>
<!DOCTYPE html>
                                ...
                                <!-- Content Start from here customized -->
                                    ...
                                    <fieldset>
                                                <div class="control-group">
                                                    <label class="span12"> Country Name <input class="span5 k-textbox" type="text" name="name" /> </label>
