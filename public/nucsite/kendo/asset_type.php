...
if(isset($_POST['save']))
{
	...
	if(!empty($name))
	{
		...
		{
			if($obj->insert($table,array("store_id"=>$input_by,"uid"=>$input_by,"name"=>$name,"date"=>date('Y-m-d'),"status"=>1))==1)
			{
                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="font-cogs"></i> Asset Type Add -> Setting </h5>
                            <ul class="icons">
                        ...
                        <div class="body">
                            ...
                            <div class="container">
								...
								<?php if(@$_GET['edit']){ ?>
                                <h3 class="subtitle"> Asset Type Edit Detail</h3>
	...
	<input class="span6 k-textbox" value="<?php echo $obj->SelectAllByVal($table,"id",$_GET['edit'],"name"); ?>" type="text" name="name" /><input type="hidden" value="<?php echo $_GET['edit']; ?>" name="id">
                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
                                    <h5><i class="icon-list-alt"></i> Asset Type List</h5>
                                        <ul class="icons">
                            ...
                            <div class="table-overflow">
                                ...
                                <div id="grid" style="margin-left: 10px;margin-right: 10px;"></div>
                                        ...
                                        <script id="action_template" type="text/x-kendo-template">
                                            <a class="k-button k-button-icontext k-grid-delete" href="asset_type.php?edit=#=id#"><i class="icon-edit"></i> Edit</a> 
                                        ...
                                        <script type="text/javascript">
                                            jQuery(document).ready(function () {
                                                ...
                                                jQuery("#grid").kendoGrid({
                                                    ...
                                                    groupable: true,
                                                    columns: [
                                                        {field: "id", title: "Asset Type-ID"},
                                                        {field: "name", title: "Asset Type Name"},
