...
if (isset($_POST['create'])) {
    ...
    if ($chk == 0) {
        if ($obj->insert($table, array("store_id" => $input_by,"thermal_width"=>$width,"thermal_height"=>$height,"date" => date('Y-m-d'), "status" => 1)) == 1) {
            $obj->Success("Successfully Set.", $obj->filename());
        } else {
            $obj->Error("Something is wrong, Try again.", $obj->filename());
        }
    } else {
        if ($obj->update($table, array("store_id" => $input_by,"thermal_width"=>$width,"thermal_height"=>$height,"date" => date('Y-m-d'), "status" => 1)) == 1) {
                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="font-cogs"></i> Thermal Paper Print Setting </h5>
                            <ul class="icons">
                                ...
                                <form class="form-horizontal" method="post" name="invoice" action="">
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="width" id="width" value="<?php echo @$possetting[0]->thermal_width; ?>" class="span8 k-textbox" placeholder="Set Printer Page Width" /> <small>Default Width is 58</small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="height" id="height" value="<?php echo @$possetting[0]->thermal_height; ?>"  class="span8 k-textbox" placeholder="Set Printer Page Height" /> <small>Default Height is 240</small>
                                            </div>
                                        </div>
