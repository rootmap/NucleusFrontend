                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="font-cogs"></i> BuyBack Device Type Setting </h5>
                            <ul class="icons">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row-fluid  span6 well">     
                                                ...
                                                <div class="control-group">
                                                    <label class="span12"> Device Type </label>
                                    ...
                                    <form class="form-horizontal" method="post" enctype="multipart/form-data" name="invoice" action="">
                                        <fieldset>
                                            ...
                                            <div class="row-fluid  span6 well">     
                                                ...
                                                <div class="control-group">
                                                    <label class="span12"> Device Type </label>
                                                    <input class="span6 k-textbox" placeholder="Put Here Device Type Name" type="text" name="name" />
                                                </div>
                                ...
                                <div class="block well">
                                    <div class="navbar">
                                        <div class="navbar-inner">
                                            <h5><i class="icon-list-alt"></i>Buyback Device Type List</h5>
                                            <ul class="icons">
                                    ...
                                    <div class="table-overflow">
                                        ...
                                        <script id="action_template" type="text/x-kendo-template">
                                            <a class="k-button k-button-icontext k-grid-delete" href="buyback_device_type.php?edit=#=id#"><i class="icon-edit"></i> Edit</a> 
                                            ...
                                            function deleteClick(id) {
                                                ...
                                                if (c === true) {
                                                    $.ajax({
                                                        type: "POST",
                                                        dataType: "json",
                                                        url: "./controller/buyback_device_type.php",
                                                        data: {id: id},
                                        ...
                                        <script type="text/javascript">
                                            jQuery(document).ready(function () {
                                                ...
                                                jQuery("#grid").kendoGrid({
                                                    ...
                                                    groupable: true,
                                                    columns: [
                                                        {field: "id", title: "Buyback Device Type-ID ", width: "60px"},
                                                        {field: "name", title: "Device Type Name", width: "100px"},
                                                        {field: "date", title: "Date Added", width: "80px"},
                                                        {
