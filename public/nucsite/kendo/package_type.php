...
if(isset($_POST['create']))
{
	...
	if(!empty($name))
	{
			...
			if($chks==0)
			{
					...
					if($obj_site->insert($table,array("name"=>$name,"available_day"=>$available_day,"date"=>date('Y-m-d'),"status"=>1))==1)
					{
						$obj_site->Success("Package Type Name Successfully Saved", $obj->filename());
					}
					else
					{
...
if(isset($_POST['editcreate']))
{
	...
	if(!empty($name))
	{
			...
			if($chks==1)
			{
					...
					if($obj_site->update($table,array("id"=>$id,"name"=>$name,"available_day"=>$available_day))==1)
					{
						$obj_site->Success("Package Type Name Successfully Saved", $obj->filename()."?edit=".$_GET['edit']);
					}
					else
					{
...
if(isset($_GET['del']))
{
	$obj_site->deletesing("id",$_GET['del'],"package_type");	
}
                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="font-plus-sign"></i> Package Info </h5>
                            <ul class="icons">
                                           ...
                                           <!-- Selects, dropdowns -->
                                            <div class="span6" style="padding:0px; margin:0px;">
                                                ...
                                                <div class="control-group">
                                                    <label class="span4"> * Package Name:</label>
                                                    <div class="span8"><input value="<?php echo $obj_site->SelectAllByVal($table,"id",$_GET['edit'],"name"); ?>" placeholder="Business Type Name" class="span12" type="text" name="name" /></div>
                                                </div>
                                                
                                                <div class="control-group">
                                                    <label class="span4"> * Service Day:</label>
                                                    <div class="span8"><input value="<?php echo $obj_site->SelectAllByVal($table,"id",$_GET['edit'],"available_day"); ?>" placeholder="Available Day" class="span12" type="text" name="available_day" /></div>
                                                </div>
                                                
                                                <div class="control-group">
                                                    <button type="submit" name="editcreate" class="btn btn-success">
                                                    <i class="icon-plus-sign"></i>Save Package </button>
                                                </div>
                                                <?php }else{ ?>
                                                <div class="control-group">
                                                    <label class="span4"> * Package Name:</label>
                                                ...
                                                <div class="control-group">
                                                    <label class="span4"> * Service Day:</label>
                                                    <div class="span8"><input placeholder="Available Day" class="span12" type="text" name="available_day" /></div>
                                                </div>
                                            ...
                                            <div class="span6" style="padding:0px; margin:0px; float:right;">
                                                ...
                                                <div class="table-overflow">
                                                    <table class="table table-striped" id="data-table">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $sql_store=$obj_site->SelectAll("package_type");
															$i=1;
															if(!empty($sql_store))
