...
if ($verb == "GET") {
    if (isset($_GET['filter'])) {
        ...
        $sqlpar="SELECT i.`sid` as id, 
                                    ...
                                    FROM `sales_cron` as i
                                    WHERE i.total!='' 
                                    " . $migratecond . " order by `i`.`sid` DESC LIMIT $start,$pagesize";
  ...
  `sales_id` int(20)
        ...
        $sqlpars="SELECT i.`sid` as id, 
                                    ...
                                    FROM `sales_cron` as i
                                    WHERE i.total!='' 
                                    " . $migratecond . " order by `i`.`sid` DESC";
       ...
       $sql_coustomer = $obj->FlyQuery("SELECT i.`sid` as id, 
                                    i.`invoice_id`, 
                                    i.`customer`, 
                                    i.`tender` AS pty,
                                    i.`status`, 
        ...
        $totalrows = $obj->FlyQuery("SELECT i.`sid` as id, 
                                    i.`invoice_id`, 
                                    i.`customer`, 
                                    i.`tender` AS pty,
                                    i.`status`, 
                                    ...
                                    FROM `sales_cron` as i
                                    WHERE i.total!='' 
                                    " . $migratecond . " order by `i`.`sid` DESC", 1);
