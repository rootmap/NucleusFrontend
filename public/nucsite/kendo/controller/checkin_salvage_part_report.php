    ...
    if (isset($_GET['filter'])) {
        ...
        if ($input_status == 1) {
            ...
            if (!empty($sqlchain_store_ids)) {
                ...
                $migratecond = $cond . $inner_cond . " crt.salvage_part!='0'";
            } else {
                $confilter = '';
            ...
            $migratecond = $cond . " " . $newcond . " crt.salvage_part!='0'";
        }
        ...
        $sqlpars .="#if not admin  
                    ...
                    CASE crt.salvage_part WHEN 1 THEN 'YES'
                    ELSE 'NO' END AS salvage_part,
                    ...
                    INNER JOIN store as s ON s.store_id=r.input_by AND s.status='2'
                    " . $migratecond . "
        ...
        if ($input_status == 1) {
            $migratecond = " WHERE crt.salvage_part!='0'";
        } elseif ($input_status == 5) {
            ...
            if (!empty($sqlchain_store_ids)) {
                ...
                $migratecond = $cond . $inner_cond . " AND crt.salvage_part!='0'";
            ...
            $newcond = " " . $conds_operate . " `r`.`input_by`='" . $input_by . "'";
            $migratecond = $cond . $newcond . " AND crt.salvage_part!='0'";
        }
