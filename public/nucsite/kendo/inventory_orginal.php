...
<html lang="en">
    ...
    <body>
        ...
        <div class="wrapper three-columns">
                                                ...
                                                <div class="span6" style="padding:0px; margin:0px;">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls"><input value="<?php
                                                            ...
                                                            echo $name;
                                                            ?>" class="span12 k-textbox" type="text" name="name" /></div>
                                                    </div>
                                                    <?php
                                                    $lcdst = 0;
                                                ...
                                                <div class="span6" style="padding:0px; margin:0px; float:right;">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            ?>
                                                            <input class="span6 k-textbox"  value="<?php echo $instock; ?>"  type="number" name="instock" />
                                                                ...
                                                                if (!empty($sqlcc)) {
                                                                    ...
                                                                    foreach ($sqlcc as $cc):
                                                                        ...
                                                                        <div class="span12" style="padding-left: 0px; margin-left: 0px;">
                                                                            <button class="btn k-button" style="width: 100px;"><?php echo $cc->name; ?></button> 
                                                                            <input class="span4 k-textbox" type="text" name="quant[]" value="<?php echo $cc->quantity; ?>" />
                                                                            <input class="span4 k-textbox" type="hidden" name="color_id[]" value="<?php echo $cc->id; ?>" />
                                                                        </div>
                                                                        <?php
                                                                        $i++;
                                                                    endforeach;
                                        ...
                                        <?php } else { ?>
                                            <div class="row-fluid  span12 well">
                                                ...
                                                <div class="span6" style="padding:0px; margin:0px;">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls" id="ppid">
                                                            <select name="pid" onChange="product(this.value)" id="pid">
                                                                <?php
                                                                ...
                                                                if ($input_status == 1) {
                                                                    ...
                                                                    $sqlproduct = $obj->SelectAllByID("product", array("input_by" => $input_by));
                                                                }
                                                                if (!empty($sqlproduct))
                                                ...
                                                <div class="span6" style="padding:0px; margin:0px; float:right;">
                                                    ...
                                                    <div class="control-group">
                                                        <label class="control-label">Reorder at:</label>
                                                        <div class="controls"><input  placeholder="Product Re-Order"  class="span4 k-textbox" type="number" name="reorder" id="reorder" /></div>
                                                    </div>

                                                    <div class="control-group">
                                                        <label class="control-label">* Quantity:</label>
                                                        <div class="controls"><input placeholder="Product Current Quantity"  class="span4 k-textbox" type="number" name="quantity" id="quantity" /></div>
                                                    </div>
            ...
            ?>
            <script>
                nucleus("#pid").css("width","100%");
                nucleus("#pid").kendoDropDownList({
                    optionLabel: " Please Select A Product / Create New One "
                }).data("kendoDropDownList").select(0);
                
                nucleus("select[name='warranty']").css("width","100%");
                nucleus("select[name='warranty']").kendoDropDownList({
                    optionLabel: " Please Select Warranty Length "
                }).data("kendoDropDownList").select(0);
                
                nucleus("select[name='vendor']").css("width","100%");
