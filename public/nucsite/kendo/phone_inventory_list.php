                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="font-phone"></i> Phone Inventory List</h5>
                            <ul class="icons">
                        ...
                        <div class="body">
                                ...
                                <div class="block">
                                    ...
                                    <div class="table-overflow">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            jQuery(document).ready(function () {
                                                ...
                                                var dataSource = new kendo.data.DataSource({
                                                    ...
                                                    transport: {
                                                        read: {
                                                            url: "./controller/device_inventory.php<?php echo $cond; ?>",
                                                            type: "GET",
                                                            datatype: "json"
                                                        }
                                                    },
                                        ...
                                        jQuery("#export-grid").click(function (e) {
                                            ...
                                            JSONToCSVConvertor(json_data, "Phone Inventory List", true);
                                        ...
                                        function JSONToCSVConvertor(JSONData, ReportTitle, ShowLabel) {
                                            ...
                                            var fileName = "phone_inventory_list_";
                            ...
                            <!--<th>Quantity</th>-->
                                            ...
                                            <tbody>
                                                <?php
                                                if ($input_status == 1) {
                                                    //$sql_product=$obj->SelectAllNOASC("product_phone_inventory");
                                                    ...
                                                    if (!empty($sqlchain_store_ids)) {
                                                        ...
                                                        //include('class/report_chain_admin.php');
                                                        //$obj_report_chain=new chain_report();
                                                        //$sql_product=$obj_report_chain->SelectAllByID_Multiple_Or("product_phone_inventory", $array_ch, "input_by", "1");
                                                    }else {
                                                        //echo "Not Work";
                                                        $sql_product="";
                                                    }
                                                    ...
                                                    //$sql_product=$obj->SelectAllByID_Multiple_Inventory("product_phone_inventory", array("input_by"=>$input_by));
                                                }
                                                $i=1;
