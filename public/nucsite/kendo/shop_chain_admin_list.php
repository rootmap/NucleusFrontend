                            ...
                            <div class="container">
                                ...
                                <div class="table-overflow">
                                    ...
                                    <script id="action_template" type="text/x-kendo-template">
                                        <a class="k-button k-button-icontext k-grid-delete" href="shop_chain_admin_list.php?edit=#=id#"><i class="icon-edit"></i> Edit</a> 
                                        ...
                                        function deleteClick(id) {
                                            ...
                                            if (c === true) {
                                                $.ajax({
                                                    type: "POST",
                                                    dataType: "json",
                                                    url: "./controller/shop_chain_admin_list.php",
                                                    data: {id: id},
                                    ...
                                    <?php /*<table class="table table-striped" id="data-table">
                                        ...
                                        <tbody>
<?php
$sql_store = $obj->SelectAll("shop_chain_admin");
$i = 1;
