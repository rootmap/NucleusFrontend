...
$table2="checkin_version_color";
$table3="checkin_version";
$table4="checkin";
?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="container">
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span12">
                                        ...
                                        <div  class="progress progress-success value"><div class="bar" data-percentage="4" data-amount-part="4" data-amount-total="8">4/8</div></div>
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span12">
                                        <div class="semi-block">
                                            <div class="well-white body">
                                                    <h5 class="subtitle align-center"> Your Device : <?php echo $obj->SelectAllByVal($table4,"id",$_GET['id'],"name"); ?>,<?php echo $obj->SelectAllByVal($table3,"id",$_GET['version'],"name"); ?>, Color - <?php echo $obj->SelectAllByVal($table2,"id",$_GET['color'],"name"); ?>  </h5>
                                                    <div class="separator"><span></span></div>
                                                    <h3 class="subtitle align-center"> Select Network  </h3>
										...
										$data=$obj->SelectAllByID_Multiple($table,array("checkin_id"=>$_GET['id']));
													...
													{
							$data=$obj->SelectAllByID_Multiple("checkin_network_store",array("checkin_id"=>$_GET['id'],"store_id"=>$input_by));	
													}
													if(!empty($data))
													foreach($data as $row):
													
													?>
                                        <a href="checkin5.php?id=<?php echo $_GET['id']; ?>&amp;version=<?php echo $_GET['version']; ?>&amp;color=<?php echo $_GET['color']; ?>&amp;network=<?php echo $row->id; ?>" style="height:30px; padding-left:20px; padding-right:20px; line-height:30px; font-size:18px;" class="btn"> <?php echo $row->name; ?> </a>
                                                    <?php  
													endforeach;
													?>
                                                    </div>
