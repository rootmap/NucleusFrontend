...
if (isset($_GET['newticket'])) {
    ...
    $obj->Success("New Ticket Token Has Been Created Successfully", $obj->filename() . "?cid=" . $cid);
}
...
<html lang="en">
    ...
    <body>
        ...
        <div class="wrapper three-columns">
                        ...
                        <div class="body">
                            ...
                            <div class="container">
                                ...
                                <div class="block span6">
                                    <a href="<?php echo $obj->filename(); ?>?newticket=1&amp;cid=<?php echo $cid; ?>" class="btn btn-danger"><i class="icon-ok-sign"></i>New Ticket</a>
                                </div>
                                        ...
                                        <div class="row-fluid block well">
                                            ...
                                            <div class="span6" style="margin: 0;">
                                                <div class="control-group" id="newcus">
                                                    <label class="control-label" style="width: 175px;">* Select Customer: </label>
                                                    <div class="controls">
                                                        <select name="customername" onChange="newcustomerticket(this.value)" id="customername">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls"><input type="text" name="title" class="span8" placeholder="Ticket Title" />
                                                        ...
                                                        <input type="hidden" name="cid" value="<?php echo $cid; ?>" class="span8" >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls" id="new_problem">
                                                        ...
                                                        <select name="problem_type" onChange="new_problem(this.value, 'new_problem')" id="problem_type">
                                                            <?php
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row-fluid">
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <select id="allexasset" onChange="ticket_asset(this.value, '<?php echo $cart; ?>')" name="select2" data-placeholder="Choose a Existing Asset...">											
                                                                    <option value="">Select a existing asset</option>
                                                                    <?php
            ...
            ?>
            <script>
                nucleus("select[name='problem_type']").css("width", "200px");
                nucleus("select[name='problem_type']").kendoDropDownList({
                    optionLabel: " Please Select Problem Type "
