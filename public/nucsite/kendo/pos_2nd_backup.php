                                            ...
                                            <div class="tabbable">
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane" id="tab201">
                                                        ...
                                                        $as = 1;
														if($input_status==1){
														$sqlproduct = $obj_pos->SelectAllOnlyLimit("product_phone_inventory","0","300");
														}else{
														$sqlproduct =$obj_pos->SelectAllOnlyOneCondLimit("product_phone_inventory","input_by",$input_by,"0","300");	
														}
                                                        if (!empty($sqlproduct))
                                                            foreach ($sqlproduct as $product):
                                                                if ($as == 1) {
