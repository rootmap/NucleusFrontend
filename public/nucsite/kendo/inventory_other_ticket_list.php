                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="font-home"></i> Other Inventory</h5>
                            <ul class="icons">
                            ...
                            <div class="table-overflow">
                                <table class="table table-striped" id="data-table">
                                    ...
                                    <tbody>
										...
										if($input_status==1)
										{
                                        	$sql_product=$obj->SelectAll("product");
										}
										else
										{
											$sql_product=$obj->SelectAllByID_Multiple("product",array("input_by"=>$input_by));	
										}
										$i=1;
										if(!empty($sql_product))
										foreach($sql_product as $product):
										if($product->description!="Product Added From Ticket" && $product->description!="Product Added From Unlock" && $product->description!="Product Added From Checkin")
										{
										?>
                                        <tr>
                                            <td><?php echo $i; ?></td>
