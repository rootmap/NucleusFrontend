...
if (isset($_POST['create'])) {
    ...
    //$obj->Success("Your Maintain Stock Variance Report has been generated", "maintain_stock_varience.php?lotno=" . $lotno);
    if ($cashman == 1) {
                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="icon-random"></i> <?php if (!isset($_GET['ac'])) { ?> Create Maintain Stock Variance <?php }else { ?> Maintain Stock Variance Report <?php } ?> </h5>
                            <ul class="icons">
