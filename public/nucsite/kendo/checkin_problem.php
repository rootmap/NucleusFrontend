...
if(@$_GET['del'])
{
	...
	{
		$obj->delete("store_checkin_problem",array("sid"=>$_GET['sid']));
...
if(isset($_POST['save']))
{
	...
	if(!empty($name) && !empty($checkin))
	{
		...
		{
			if($obj->exists_multiple("checkin_problem_store",array("store_id"=>$input_by,"name"=>$name,"checkin_id"=>$checkin))==0)
			{
				if($obj->insert($table,array("store_id"=>$input_by,"name"=>$name,"checkin_id"=>$checkin,"date"=>date('Y-m-d'),"status"=>1))==1)
				{
					$new_network_id=$obj->SelectAllByVal3($table,"name",$name,"store_id",$input_by,"checkin_id",$checkin,"id");
					$obj->insert("store_checkin_problem",array("id"=>$new_network_id,"store_id"=>$input_by,"date"=>date('Y-m-d'),"status"=>1));
                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="font-cogs"></i> Check In Problem Setting </h5>
                            <ul class="icons">
...
<!--                        	<div class="navbar">
                            	<div class="navbar-inner">
                                    <h5><i class="icon-list-alt"></i>CheckIn Problem List</h5>
                                        <ul class="icons">
                            ...
                            <div class="table-overflow">
                                <div id="grid" style="margin-left: 10px;margin-right: 10px;"></div>
                                        ...
                                        <script id="action_template" type="text/x-kendo-template">
                                            <a class="k-button k-button-icontext k-grid-delete" href="checkin_problem.php?edit=#=checkin_problem_id#"><i class="icon-edit"></i> Edit</a> 
                                            <a class="k-button k-button-icontext k-grid-delete" onclick="javascript:deleteClick(#=checkin_problem_id #);" ><span class="k-icon k-delete"></span> Delete</a>
                                        </script>
                                            ...
                                            function deleteClick(id) {
                                                ...
                                                if (c === true) {
                                                    $.ajax({
                                                        type: "POST",
                                                        dataType: "json",
                                                        url: "./controller/checkin_problem.php",
                                                        data: {id: id},
                                            ...
                                            jQuery(document).ready(function () {
                                                var dataSource = new kendo.data.DataSource({
                                                    ...
                                                    schema: {
                                                        ...
                                                        model: {
                                                            id: "id",
                                                            fields: {
                                                                checkin_problem_id: {type: "number"},
                                                ...
                                                jQuery("#grid").kendoGrid({
                                                    ...
                                                    columns: [
                                                        ...
                                                        {field: "checkin_problem_id", title: "Checkin Problem ID", filterable: false},
                                                        {field: "problem_name", title: "Problem Name"},
                                ...
                                <?php /*<table class="table table-striped" id="data-table">
                                    ...
                                    <tbody>
										...
										elseif($input_status==5)
										{
												...
												$sql_checkin_network=$obj_report_chain->SelectAllByID_Multiple_Or("checkin_problem_store",$array_ch,"store_id","1");
										}
										else
										{
											$sql_checkin_network=$obj->SelectAllByID("checkin_problem_store",array("store_id"=>$input_by));
										}
