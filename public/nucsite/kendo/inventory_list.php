    ...
    if (!empty($sql_product))
        foreach ($sql_product as $product):
            ...
            $data.="<tr>
				...
				<td>" . number_format($product->price_cost, 2) . "</td>
                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="font-map-marker"></i> Parts / Checkin Inventory</h5>
                            <ul class="icons">
                                ...
                                <div class="block">
                                    ...
                                    <div class="table-overflow">
                                        ...
                                        <script id="edit_client" type="text/x-kendo-template">
                                            ...
                                            <a href="<?php echo $obj->filename(); ?>?del=#=id#" class="hovertip" title="Delete Product" onclick="javascript:return confirm('Are you absolutely sure to delete This Product ?')"><i class="icon-trash"></i></a>
                                        </script>
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            jQuery(document).ready(function () {
                                                ...
                                                var dataSource = new kendo.data.DataSource({
                                                    ...
                                                    transport: {
                                                        read: {
                                                            url: "./controller/parts_inventory.php<?php echo $cond; ?>",
                                                            type: "GET",
                                                            datatype: "json"
                                                        }
                                                    },
                                        ...
                                        jQuery("#export-grid").click(function (e) {
                                            ...
                                            JSONToCSVConvertor(json_data, "Inventory List", true);
                                    ...
                                    <?php /* ?><div class="table-overflow">
                                      ...
                                      <?php
                                      if ($input_status == 1) {
                                      $sql_product=$obj->FlyQuery("SELECT * FROM product_checkin_inventory LIMIT 100");
                                      }elseif ($input_status == 5) {
                                      ...
                                      <td><a href="inventory_stockout.php?pid=<?php
                                      echo $product->id;
                                      ?>" class="label label-warning hovertip" title="StockOut Product"><i class="icon-download"></i></a>
                                      <a href="inventory_stockin.php?pid=<?php echo $product->id; ?>" class="label label-info hovertip" title="Stockin Product"><i class="icon-upload"></i></a></td>
                                      <?php
                                      }
                                      $instock_total_inventory+=$instock;
                                      $prt=$product->price_cost * ($instock);
                                      ...
                                      <?php } ?>
                                      <?php } ?>
                                      <div style="display: none;"  class="td_price_cost"><?php echo $prrt; ?></div>
                                      <div style="display: none;" class="td_price_retail"><?php echo $prt; ?></div>
                                      </td>
                                      </tr>
                                      <?php
                                      $i++;
                                      ...
                                      <!--<td><label class="label label-primary"> <?php //echo $product->quantity;                                                                                                                                                                      ?> </label></td>-->
                                      <td><a href="inventory_stockout.php?pid=<?php echo $product->id; ?>" class="label label-warning hovertip" title="StockOut Product"><i class="icon-download"></i></a>
                                      <a href="inventory_stockin.php?pid=<?php echo $product->id; ?>" class="label label-info hovertip" title="Stockin Product"><i class="icon-upload"></i></a></td>
                                      <?php
                                      }
                                      $instock_total_inventory+=$instock;
