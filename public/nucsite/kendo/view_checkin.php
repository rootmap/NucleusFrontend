    ...
    <body>
        ...
        <div class="wrapper three-columns">
            ...
            <div class="content">
                ...
                <?php
                echo $obj->ShowMsg();
                $checkin_price = $obj->SelectAllByVal("checkin_cron", "checkin_id", $ticket_id, "checkin_price");
                ...
                if (empty($checkin_price)) {
                    $new_checkin_price = $pp;
                } else {
                    $new_checkin_price = $checkin_price;
                }
                ?>
                <!-- /info notice -->
                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <form>
                                <h5><i class="icon-check"></i> Checkin ID : <?php echo $ticket_id; ?>  <label style="margin-left: 30px;">
...
//$sqlpagecheckinlist_info=$obj->SelectAllByID_Multiple("checkin_list", array("checkin_id"=>$ticket_id));
                                                    ...
                                                    <div class="span12">
                                                        <label class="span12"> <strong class="span5">Est. Price: </strong>
                                                            ...
                                                            <?php if ($curcheck == 0) {
                                                                ?>
                                                                <a class="btn btn-info" href="pos.php?newsales=1&amp;pid=<?php echo $pid; ?>&amp;price=<?php echo number_format($new_checkin_price, 2); ?>&amp;checkin_id=<?php echo $ticket_id; ?>&AMP;cid=<?php echo $cid; ?>">$<?php
                                                                    if (empty($new_checkin_price)) {
                                                                        echo 0;
                                                                    } else {
                                                                        echo number_format($new_checkin_price, 2);
                                                                    }
                                                                    ?> Send To Pos</a>
                                                            <?php } else { ?>
                                                                <span class="label label-info" href="pos.php?newsales=1&amp;pid=<?php echo $pid; ?>&amp;price=<?php echo number_format($new_checkin_price, 2); ?>&amp;checkin_id=<?php echo $ticket_id; ?>&AMP;cid=<?php echo $cid; ?>">$<?php
                                                                    if (empty($new_checkin_price)) {
                                                                        echo 0;
                                                                    } else {
                                                                        echo number_format($new_checkin_price, 2);
                                                    ...
                                                    <div id="checkin_custom_fields">
                                                        ...
                                                        <div class="span12" style="margin-left:-10px;">
                                                            ...
                                                            <label class="checkbox span3"> <strong>Tested Before By :</strong>
                                                                <?php echo $obj->SelectAllByVal('checkin_request_ticket', 'checkin_id', $ticket_id, 'tested_before'); ?>
                                                            </label>
                                                        </div>
                                                        <div class="span12" style="margin-left:-10px;">
                                                            <label class="checkbox span6 pull-left">
                                                                <strong>Tested After By : </strong>
                                                                <?php echo $obj->SelectAllByVal('checkin_request_ticket', 'checkin_id', $ticket_id, 'tested_after'); ?>
                                                            </label>
...
//$obj->SelectAllByID_Multiple("ticket_custom_selection", array("ticket_id" => $ticket_id));
                                        ...
                                        <?php
                                        echo $sqlpagecheckinrequest[0]->id;
                                        $chkcheckinid = $obj->FlyQuery("SELECT `chid` FROM `checkin_cron` WHERE `chid`='" . $sqlpagecheckinrequest[0]->id . "'", 1);
                                        if ($chkcheckinid == 0) {
                                            $obj->FlyPrepare("INSERT INTO `checkin_cron` SET `chid`='" . $sqlpagecheckinrequest[0]->id . "',`checkin_id`='" . $ticket_id . "', `detail`='" . $device_detail . "', `problem`='" . $problem . "', `checkin_price`='" . $new_checkin_price . "', `paid`='" . $paid_amount . "', `date`='" . $sqlpagecheckinrequest[0]->date . "', `input_by`='" . $sqlpagecheckinrequest[0]->creator . "', `invoice_id`='" . $getsales_id . "', `pid`='" . $pid . "', `cid`='" . $cid . "'");
                                            //echo $i . "-" . $checkin->checkin_id . "-" . $checkin->input_by . "<br>";
                                        } else {
                                            $obj->FlyPrepare("UPDATE `checkin_cron` SET `checkin_id`='" . $ticket_id . "', `detail`='" . $device_detail . "', `problem`='" . $problem . "', `checkin_price`='" . $new_checkin_price . "', `paid`='" . $paid_amount . "', `date`='" . $sqlpagecheckinrequest[0]->date . "', `input_by`='" . $sqlpagecheckinrequest[0]->creator . "', `invoice_id`='" . $getsales_id . "', `pid`='" . $pid . "', `cid`='" . $cid . "' WHERE `chid`='" . $sqlpagecheckinrequest[0]->id . "'");
