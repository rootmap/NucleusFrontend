                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="font-hdd"></i> Maintain Stock Inventory  </h5>
                            <ul class="icons">
                                ...
                                <div class="block">
                                    <div class="table-overflow">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            jQuery(document).ready(function () {
                                                ...
                                                var dataSource = new kendo.data.DataSource({
                                                    ...
                                                    transport: {
                                                        read: {
                                                            url: "./controller/maintain_stock_inventory.php<?php echo $cond; ?>",
                                                            type: "GET",
                                                            datatype: "json"
                                                        }
                                                    },
                                        ...
                                        jQuery("#export-grid").click(function (e) {
                                            ...
                                            JSONToCSVConvertor(json_data, "Inventory Maintain List", true);
                                        ...
                                        function JSONToCSVConvertor(JSONData, ReportTitle, ShowLabel) {
                                            ...
                                            var fileName = "inventory_maintain_list_";
