                        ...
                        <!--<th>Quantity</th>-->
                                            ...
                                            <tbody>
                                                ...
                                                if ($input_status == 1) {
                                                    ...
                                                    WHERE `a`.`description` <> 'Product Added From Ticket'  
                                                    AND `a`.`description` <> 'Product Added From Unlock' 
                                                    AND `a`.`description` <> 'Product Added From Checkin' 
                                                    AND `a`.`status` <> '4' 
                                                    ...
                                                    product_other_inventory as a
                                                    LEFT JOIN sales as s ON s.pid=a.id 
                                                    WHERE a.input_by='" . $input_by . "' AND `a`.`description` <> 'Product Added From Ticket'  
                                                    AND `a`.`description` <> 'Product Added From Unlock' 
                                                    AND `a`.`description` <> 'Product Added From Checkin' 
                                                    AND `a`.`status` <> '4' 
                                                    AND `a`.`status` <> '5' AND `a`.`status` <> '6'  GROUP BY a.id) as alldata");
                                                    //$sql_product=$obj->SelectAllByID_Multiple_Inventory("product_other_inventory", array("input_by"=>$input_by));
                                                    //490
                                                    //50
                                                    //40.5
