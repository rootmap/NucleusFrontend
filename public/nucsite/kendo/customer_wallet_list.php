                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="icon-tasks"></i> Customer Wallet List </h5>
                            <!--                            <ul class="icons">
                                ...
                                <div class="table-overflow">
                                    ...
                                    <div class="k-grid  k-secondary" data-role="grid" style="margin-left: 10px;margin-right: 10px;">
                                        ...
                                        <div class="k-toolbar k-grid-toolbar">
                                            <a class="k-button k-button-icontext k-grid-add" href="customer_wallet.php">
                                                <span class="k-icon k-add"></span>
                                                Add New Customer Wallet
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <script id="action_template" type="text/x-kendo-template">
                                        <a class="k-button k-button-icontext k-grid-delete" href="customer_wallet.php?edit=#=id#"><i class="icon-edit"></i> Edit</a> 
                                        ...
                                        function deleteClick(id) {
                                            ...
                                            if (c === true) {
                                                $.ajax({
                                                    type: "POST",
                                                    dataType: "json",
                                                    url: "./controller/customer_wallet_list.php",
                                                    data: {id: id},
                                    ...
                                    <script type="text/javascript">
                                        jQuery(document).ready(function () {
                                            var dataSource = new kendo.data.DataSource({
                                                transport: {
                                                    read: {
                                                        url: "./controller/customer_wallet_list.php<?php echo $cond; ?>",
                                                        type: "GET",
                                                        datatype: "json"
                                            ...
                                            jQuery("#grid").kendoGrid({
                                                ...
                                                columns: [
                                                    ...
                                                    {field: "diposit_amount", title: "Diposit Amount"},
                                                    {field: "withdrawal_amount", title: "Withdrawal Amount"},
                                                    {field: "pending_amount", title: "Pending Amount"},
                                                    {field: "balance_amount", title: "Balance Amount"},
                                                    {
