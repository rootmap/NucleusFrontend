...
if (isset($_POST['create'])) {
    ...
    if ($s == 0) {
        ...
        $obj->insert("varience", array("store_id"=>$input_by, "input_by"=>$input_bys, "lotno"=>$lotno, "date"=>date('Y-m-d'), "status"=>2));
        if ($cashman == 1) {
            $obj->Success("Thank You, Verience Created Successfully.", "phone_verience.php?lotno=" . $lotno);
        }else {
                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="font-phone"></i>Create Phone Inventory Variance</h5>
                            <ul class="icons">
                                                    ...
                                                    if (!empty($sql_product))
                                                        foreach ($sql_product as $product):
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="create_phone_verience.php?pid=<?php echo $product->id; ?>" class="label label-info hovertip" title="Create a Variance">
