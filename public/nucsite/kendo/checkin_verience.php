                ...
                <div class="outer">
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="icon-random"></i> Checkin Variance Report <?php if (isset($_GET['lotno'])) { ?> Detail | <a href="<?php echo $obj->filename(); ?>">Back To Checkin Variance Report List</a> <?php } ?> </h5>
                            <ul class="icons">
                        ...
                        <div class="body">
                            ...
                            <div class="container">
                                    ...
                                    if (!isset($_GET['lotno'])) {
                                        ...
                                        <div class="table-overflow">
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                type: "POST",
                                                        dataType: "json",
                                                        url: "./controller/veriance_checkin.php",
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                requestStart: showLoading,
                                                        transport: {
                                                        read: {
                                                        url: "./controller/veriance_checkin.php<?php echo $cond; ?>",
                                                                type: "GET",
                                                                datatype: "json"
                                                        }
                                                        },
                                                ...
                                                dataSource: dataSource,
                                                        ...
                                                        {title: "Dates", 
                                                                ...
                                                                template: kendo.template("<span><label>extra col</label></span>")
                                        ...
                                        <div class="table-overflow">
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                requestStart: showLoading,
                                                        transport: {
                                                        read: {
                                                        url: "./controller/veriance_checkin.php<?php echo $newcond; ?>",
                                                                type: "GET",
                                                                datatype: "json"
                                                        }
                                                        },
                                ...
                                <?php /* <div class="table-overflow">
                                  ...
                                  <tbody>
                                  <?php
                                  $sql_product=$obj->FlyQuery("SELECT a.*,s.name as input_bys FROM varience as a LEFT JOIN store as s on s.id=a.input_by WHERE a.store_id='" . $input_by . "' AND a.status='1' ORDER BY a.id DESC");
                                  $i=1;
                                  ...
                                  <?php
                                  $lotno=$_GET['lotno'];
                                  $sql_product=$obj->SelectAllByID_Multiple("product_verience", array("store_id"=>$input_by, "lotno"=>$lotno, "status"=>1));
                                  $i=1;
                                  if (!empty($sql_product))
                                  foreach ($sql_product as $product):
                                  ?>
