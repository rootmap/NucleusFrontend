...
class db_class {
    ...
    public function open() {
        $con = mysqli_connect("localhost", "root", "", "nucleusp_posdemo");
        mysqli_set_charset($con,"utf8");
        return $con;
    }

    public function pdocon() {
        $db = new PDO("mysql:host=localhost;dbname=nucleusp_posdemo;", "root", "");
    ...
    function baseUrl($suffix = '') {
        ...
        $web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "nucleus-frontend/cms-admin/";
        $suffix = ltrim($suffix, '/');
