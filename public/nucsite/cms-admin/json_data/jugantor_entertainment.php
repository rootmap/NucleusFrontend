...
//step1
$result = file_get_contents('http://www.jugantor.com/online/entertainment', false, $context);
//echo $result;
...
$shortdetailpage = trim(str_replace("....","",strip_tags(html_entity_decode($detaillinkMatch[0][0]))));
...
if ($obj->exists_multiple("compose_news", $exists_array) == 0) {
    ...
    $extension=$img['1'];
    $newname_image="jugantor_entertainment_".time().".".$extension;
