...
//step1
$result = file_get_contents('http://www.dailynayadiganta.com/news/7/0/%E0%A6%96%E0%A7%87%E0%A6%B2%E0%A6%BE');
//echo $result;
//bot 1st step complete
//bot grab text start
//$sPattern="/<div class=\"homeTopLeadSlider\">(.*?)<\/div>/s";
$sPattern = "/<div class=\"newsTop\">(.*?)<\/div>/s";
...
if ($obj->exists_multiple("compose_news", $exists_array) == 0) {
    ...
    $extension=$img['1'];
    $newname_image="dailynayadiganta_sport_".time().".".$extension;
