...
//step1
$result = file_get_contents('http://www.kalerkantho.com/print-edition/sports', false, $context);
...
//step2
$headingPattern =  "/<a\s[^>]*href=(\"??)(http[^\" >]*?)\\1[^>]*>(.*)<\/a>/siU";
...
if ($obj->exists_multiple("compose_news", $exists_array) == 0) {
    ...
    $extension=$img['1'];
    $newname_image="kalerkantho_sport_".time().".".$extension;
