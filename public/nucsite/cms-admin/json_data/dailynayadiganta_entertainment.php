...
//step1
$result = file_get_contents('http://www.dailynayadiganta.com/news/11/0/%E0%A6%AC%E0%A6%BF%E0%A6%A8%E0%A7%8B%E0%A6%A6%E0%A6%A8');
//echo $result;
...
if ($obj->exists_multiple("compose_news", $exists_array) == 0) {
    ...
    $extension=$img['1'];
    $newname_image="dailynayadiganta_entertainment_".time().".".$extension;
