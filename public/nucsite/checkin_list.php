...
if (isset($_GET['actionthermal'])) {
    ...
    LEFT JOIN invoice as i ON i.invoice_id=a.checkin_id
    LEFT JOIN tax_status as s ON s.store_id=a.input_by
    LEFT JOIN tax as ts ON ts.store_id=a.input_by
    LEFT JOIN setting_report as r on r.store_id=a.input_by
    LEFT JOIN store as sto on sto.id=a.access_id
    LEFT JOIN ticket as t ON t.ticket_id=a.checkin_id
    LEFT JOIN problem_type as tp ON tp.id=t.problem_type
    LEFT JOIN checkin_network as cn ON cn.id=a.network_id
    LEFT JOIN checkin_version_color as cvc ON cvc.id=a.color_id
    LEFT JOIN problem_type as pt ON pt.id=a.problem_id
    LEFT JOIN checkin_request_ticket as crt ON crt.checkin_id=a.checkin_id
...
//    exit();
    ...
    //if (!empty($sqlsaleslist))
        //foreach ($sqlsaleslist as $saleslist):
            ...
            $subtotal+=$procost;
            $html.="<tr><td colspan='2'>Ticket Detail</td></tr><tr><td colspan='2'>" . $saleslist[0]->problem . " - " . $saleslist[0]->detail . "</td></tr>";
                    ...
                    <div class="inner">
                        <div class="page-header"><!-- Page header -->
                            <h5><i class="icon-ok-circle"></i>
                                ...
                                <span><a data-toggle="modal" href="#myModal"> Generate In-Store Repair List Report</a></span>
                            ...
                            <div class="container">
                                ...
                                <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-header">
                                        ...
                                        <h5 id="myModalLabel">Generate In-Store List Report <span id="mss"></span></h5>
                                    </div>
