...
<html>
    ...
    if (isset($_GET['video'])) {
        ?>
                                title: "Playing - <?php echo $_GET['video_title']; ?>",
                                        artist: "Nucleuspos Tutorials",
                                        m4v: "cms-admin/vd/server/php/files/<?php echo $_GET['video']; ?>.mp4",
    <?php } else { ?>
                                title: "Playing - <?php echo $sqlvideolist[0]->title; ?>",
                                        artist: "Nucleuspos Tutorials",
                                        m4v: "cms-admin/vd/server/php/files/<?php echo $sqlvideolist[0]->name; ?>",
    <?php } ?>
                            poster: "images/inventorymain1.png"
