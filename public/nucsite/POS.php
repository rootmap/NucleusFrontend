...
<?php include('include/menu.php'); ?>
 ...
 <div id="slides" class="clearfix">
  ...
  <div id="employeeperformance" class="container detail slide">
    ...
    <article class="half"> <img alt="Real-time data" src="images/posmain2.png" /> </article>
 ...
 <!-- End of Day Slide -->
  ...
  <div id="endofday" class="container detail slide">
    ...
    <article class="half side-hide"> <img alt="Real-time data" src="images/posmain3.png" /> </article>
 ...
 <!-- End of End of Day Slide -->
  ...
  <div id="productreports" class="container detail slide">
    ...
    <article class="half side-hide"> <img alt="Real-time data" src="images/posmain4.png" /> </article>
...
<p>Keep track of your Profit.</p>
    ...
    <article id="first-item" class="half"> <img alt="Real-time data" src="images/posmain1.png" /> </article>
   ...
   <div class="container detail">
       ...
       <article class="half"> <img alt="Real-time data" src="images/posmain6.png" /> </article>
...
<p><em>Start today, to see why repair centers Nationwide choose Nucleus!</em></p>
    ...
    <article id="third-item" class="half"> <img alt="Phones" src="images/buybackpage3.png" /> </article>
