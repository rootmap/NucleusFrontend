...
<html>
   <head>
      ...
      <!-- pingdom --><script>var _prum = [['id', '52682908abe53d1d3f000000'], ['mark', 'firstbyte', (new Date()).getTime()]];(function() { var s = document.getElementsByTagName('script')[0] , p = document.createElement('script'); p.async = 'async'; p.src = '//rum-static.pingdom.net/prum.min.js'; s.parentNode.insertBefore(p, s);})();</script><!-- Bizible --><script async type="text/javascript" src="{{asset('nucsite/js/_biz-a.js')}}" ></script> <!--[if IE]><script src="/js/ie.js"></script>
   ...
   <body class="retail retail_reporting retail_reporting_index">
      ...
      <section class="information waves slider-container">
         ...
         <div id="slides" class="clearfix">
            ...
            <div id="employeeperformance" class="container detail slide">
               <article class="half"> <img alt="Real-time data" src="{{asset('nucsite/images/profitreportmain.png')}}" /> </article>
               <article class="half">
                  <h3>Profit Report</h3>
                  <h4>Profit Report, is your brief report of your profit from your Location, it shows you details on the product, the cost and the employee who sold it.</h4>
                  <ul>
                     <li>Shows Product Name, Sales ID, and Quanity</li>
                     <li>Total Profit, calculated from your cost, and total cost.</li>
                     <li>Choose specific dates to know which are your most profitable.</li>
                  </ul>
               </article>
            </div>
            <!-- End of Employee Performance Slide --> <!-- End of Day Slide --> 
            <div id="endofday" class="container detail slide">
               <article class="half side-hide"> <img alt="Real-time data" src="{{asset('nucsite/images/closestorereportmain.png')}}" /> </article>
               <article class="half">
                  <h3>Store Closing Report</h3>
                  <h4>End of the day is always a dread, closing the store can be a headache. But with Nucleus backend system, it calculates everything for you. That way you can end every business day a simple way. It calculates your cash, opening cash, credit card, tax, current cash, etc. & saves it all to your database to view whenever you need it!</h4>
               </article>
            </div>
            <!-- End of End of Day Slide --> <!-- Product Reports Slide --> 
            <div id="productreports" class="container detail slide">
               <article class="half side-hide"> <img alt="Real-time data" src="{{asset('nucsite/images/checkinreportmain.png')}}" /> </article>
               <article class="half">
                  <h3>Checkin Reports</h3>
                  <h4>Check-ins are your more common repairs, iPhone Repairs, Galaxy Repairs, iPad Repairs. You could say your "main source" of sales. Checkin Report helps you manage and view all your checkin report details. From, your cost, to sell cost, to profit, and the day it’s sold. You can choose a date range as well.</h4>
               </article>
            </div>
      ...
      <section class="promo-widget row-full-width">
         <div class="small-12 columns medium-12 large-9 small-centered">
            ...
            <div class="small-12 medium-3 medium-offset-1 columns small-centered medium-uncentered cta-wrapper"> <a class="cta-promo-widget" href="http://nucleuspos.com/signup.php">Start Today</a> </div>
         </div>
      </section>
      <section class="information advanced-reporting">
         <div class="container detail">
            <article class="full tag">
               <h2>Full Detailed Reproting System</h2>
               <h4>Reports are what matter in a good business, and every good business knows that. Nucleus Matters.</h4>
            </article>
         </div>
         <div class="container detail">
            <article id="second-item" class="half">
               <h2>All Report</h2>
               <h3>Advance "All Report" feature is a report designed for your CPA or Accountant. No need to go through mindless paperwork, or excel files every month to file your taxes. Just save your "All Report" via PDF or Excel, and send it your CPA! Simple is the new smart.</h3>
                
               <p>Need to share your numbers? Export Dashboard graphs as PDFs or images, or send straight to your printer.</p>
               <p>Calculates everything you would ever need in one report. No need for notepads, and excel files. This is the future. </p>
            </article>
            <article id="first-item" class="half"> <img alt="Real-time data" src="{{asset('nucsite/images/report1.png')}}" /> </article>
         </div>
         <div class="container detail">
            <article class="half"> <img alt="Real-time data" src="{{asset('nucsite/images/report2.png')}}" /> </article>
            <article class="half">
               <h2>Multiple Store Reports<br>Built for you</h2>
               <h3>Nucleus Reporting System is designed not only for one retail shop, but for multiple as well.</h3>
                
               <p>View all your sales, profit, transactions, reports, status, and more through one system!</p>
            </article>
         </div>
         <div class="container detail">
            <article id="fourth-item" class="half" style="margin-top: 20px;">
               <h2>Dashboard</h2>
               <h3>View it all briefed right out for you, from your dashboard.</h3>
                
               <p>Dashboard is your main screen on Nucleus, gives you a report for all your daily transactions. It's viewable on your iPhone, iPad, Computer, and more!</p>
               <p><em>Cloud Based, so you're never without it.</em></p>
            </article>
            <article id="third-item" class="half"> <img alt="Phones" src="{{asset('nucsite/images/dashboard1.png')}}" /> </article>
         </div>
      </section>
         ...
         <section class="information customer-thumbs">
            <div class="small-12 medium-10 large-6 columns small-centered detail">
               <article class="more small-12 medium-6 columns">
                  ...
                  <h4 class="quote">Check out this video, to see a brief summary of some business reports!!</h4>
                  <p class="quote-credit">Example of Business Reports<br> <span>Nucleus</span></p>
               </article>
            </div>
         </section>
